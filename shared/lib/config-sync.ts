...
export const CANONICAL_CONFIG_TEMPLATE: WavemillConfig = {
  ...
  router: {
    ...
    availableModels: {
      planner: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.4', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'gemini-2.5-pro', 'mistral-large-2'],
      coder: ['claude-fable-5', 'claude-sonnet-5', 'gpt-5.5', 'gpt-5.4', 'qwen-3-coder', 'qwen-2.5-coder-32b', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'gemini-2.5-pro', 'gemini-2.5-flash', 'llama-3.3-70b', 'mistral-large-2', 'devstral-small'],
      reviewer: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.4', 'qwen-3-coder', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'gemini-2.5-pro', 'gemini-2.5-flash', 'llama-3.3-70b', 'mistral-large-2'],
    },
    defaultAgent: 'codex',
    agentMap: {
