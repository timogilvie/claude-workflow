...
export const CANONICAL_CONFIG_TEMPLATE: WavemillConfig = {
  ...
  eval: {
    ...
    pricing: {
      ...
      'mistral-large-2': { inputCostPerMTok: 2, outputCostPerMTok: 6 },
      'devstral-small': { inputCostPerMTok: 0.1, outputCostPerMTok: 0.25 },
    },
  ...
  router: {
    ...
    availableModels: {
      planner: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.4', 'kimi-k2', 'glm-5.2', 'kimi-k2.7-code', 'gemini-2.5-pro', 'mistral-large-2'],
      coder: ['claude-fable-5', 'claude-sonnet-5', 'gpt-5.5', 'gpt-5.4', 'qwen-3-coder', 'qwen-2.5-coder-32b', 'kimi-k2', 'glm-5.2', 'kimi-k2.7-code', 'gemini-2.5-pro', 'gemini-2.5-flash', 'llama-3.3-70b', 'mistral-large-2', 'devstral-small'],
      reviewer: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.4', 'qwen-3-coder', 'kimi-k2', 'glm-5.2', 'kimi-k2.7-code', 'gemini-2.5-pro', 'gemini-2.5-flash', 'llama-3.3-70b', 'mistral-large-2'],
    },
    defaultAgent: 'codex',
    agentMap: {
