...
export const CANONICAL_CONFIG_TEMPLATE: WavemillConfig = {
  ...
  router: {
    ...
    availableModels: {
      planner: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.6-terra', 'deepseek-r1', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'kimi-k2-thinking', 'gemini-2.5-pro', 'qwen-3-235b', 'llama-4-maverick', 'mistral-large-2', 'mistral-medium-3'],
      ...
      reviewer: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.6-terra', 'deepseek-r1', 'deepseek-v3', 'qwen-3-coder', 'qwen-3-235b', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'kimi-k2-thinking', 'gemini-2.5-pro', 'gemini-2.5-flash', 'llama-3.3-70b', 'mistral-large-2', 'mistral-medium-3'],
    },
    defaultAgent: 'codex',
    agentMap: {
