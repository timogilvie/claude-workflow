...
export const CANONICAL_CONFIG_TEMPLATE: WavemillConfig = {
  ...
  eval: {
    ...
    pricing: {
      ...
      'qwen-2.5-coder-32b': { inputCostPerMTok: 0.2, outputCostPerMTok: 0.6 },
      ...
      'llama-3.3-70b': { inputCostPerMTok: 0.12, outputCostPerMTok: 0.3 },
      'llama-4-maverick': { inputCostPerMTok: 0.4, outputCostPerMTok: 1.6 },
      'mistral-large-2': { inputCostPerMTok: 2, outputCostPerMTok: 6, cacheReadCostPerMTok: 0.2 },
      'mistral-medium-3': { inputCostPerMTok: 1.5, outputCostPerMTok: 7.5 },
      'devstral-small': { inputCostPerMTok: 0.15, outputCostPerMTok: 0.6, cacheReadCostPerMTok: 0.015 },
      'devstral-medium': { inputCostPerMTok: 1.5, outputCostPerMTok: 7.5 },
    },
  ...
  challenge: {
    ...
    comparisonModel: 'claude-opus-4-8',
  ...
  router: {
    ...
    availableModels: {
      planner: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.6-terra', 'deepseek-r1', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'kimi-k2-thinking', 'gemini-2.5-pro', 'qwen-3-235b', 'llama-4-maverick', 'mistral-large-2'],
      coder: ['claude-fable-5', 'claude-sonnet-5', 'gpt-5.5', 'gpt-5.6-terra', 'gpt-4.1', 'deepseek-r1', 'deepseek-v3', 'deepseek-coder-v2', 'qwen-3-coder', 'qwen-3-235b', 'qwen-2.5-coder-32b', 'qwen-2.5-72b', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'kimi-k2-thinking', 'gemini-2.5-pro', 'gemini-2.5-flash', 'gemini-2.0-flash', 'llama-3.3-70b', 'llama-4-maverick', 'llama-4-scout', 'mistral-large-2', 'mistral-medium-3', 'devstral-small', 'devstral-medium', 'grok-code-fast'],
      reviewer: ['claude-fable-5', 'claude-opus-4-8', 'claude-opus-4-7', 'gpt-5.5', 'gpt-5.6-terra', 'deepseek-r1', 'deepseek-v3', 'qwen-3-coder', 'qwen-3-235b', 'glm-5.2', 'kimi-k2', 'kimi-k2.7-code', 'kimi-k2-thinking', 'gemini-2.5-pro', 'gemini-2.5-flash', 'llama-3.3-70b', 'mistral-large-2'],
    },
    defaultAgent: 'codex',
    agentMap: {
