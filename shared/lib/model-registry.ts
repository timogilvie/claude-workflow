...
export const DEFAULT_MODEL_REGISTRY: ModelRegistry = {
  models: {
    ...
    'gpt-5': {
      vendor: 'openai',
      class: 'frontier',
      strengths: ['OpenRouter parity coverage', 'strong coding', 'broad tool use'],
      weaknesses: ['opt-in provider path', 'higher cost than mini variants'],
      qualityScores: scores(59, 90, 88, 89, 58),
      pricing: {
    ...
    'gpt-5-mini': {
      vendor: 'openai',
      class: 'strong_generalist',
      strengths: ['OpenRouter fallback coverage', 'lower cost', 'fast coding'],
      weaknesses: ['less depth than full GPT-5'],
      qualityScores: scores(57, 76, 82, 80, 60),
      pricing: {
    ...
    'gpt-4.1': {
      vendor: 'openai',
      class: 'strong_generalist',
      strengths: ['mature coding baseline', 'OpenRouter watchlist coverage'],
      weaknesses: ['older generation', 'less depth than GPT-5'],
      qualityScores: scores(55, 72, 78, 77, 56),
      pricing: {
        inputCostPerMTok: 2,
        outputCostPerMTok: 8,
      },
    ...
    'deepseek-r1': {
      vendor: 'deepseek',
      class: 'frontier',
      strengths: ['reasoning-heavy OpenRouter coverage', 'launch-priority planning challenger'],
      weaknesses: ['opt-in provider path', 'slower than V3'],
      qualityScores: scores(58, 88, 84, 86, 56),
      pricing: {
        inputCostPerMTok: 3,
        outputCostPerMTok: 8,
      },
    ...
    'deepseek-v3': {
      vendor: 'deepseek',
      class: 'strong_generalist',
      strengths: ['cost-efficient OpenRouter coding', 'direct audit coverage'],
      weaknesses: ['opt-in provider path'],
      qualityScores: scores(61, 76, 84, 80, 60),
      pricing: {
    ...
    'deepseek-coder-v2': {
      vendor: 'deepseek',
      class: 'strong_generalist',
      strengths: ['coding-specialized watchlist coverage', 'low-cost challenger'],
      weaknesses: ['watchlist only', 'older generation'],
      qualityScores: scores(54, 70, 81, 76, 52),
      pricing: {
        inputCostPerMTok: 0.14,
        outputCostPerMTok: 0.28,
      },
    ...
    'qwen-2.5-coder-32b': {
      vendor: 'qwen',
      class: 'fast_economy',
      strengths: ['low-cost coding challenger', 'good code editing throughput'],
      weaknesses: ['smaller reasoning headroom'],
      qualityScores: scores(50, 64, 79, 71, 55),
      pricing: {
      ...
      latencyTier: 'fast',
      reasoningTier: 'standard',
      costPerMillionInputTokensUsd: 0.18,
      costPerMillionOutputTokensUsd: 0.18,
      agent: 'claude-openrouter',
    },
    'qwen-3-coder': {
      vendor: 'qwen',
      class: 'strong_generalist',
      strengths: ['coding-tuned challenger', 'good price/performance'],
      weaknesses: ['opt-in provider path'],
      qualityScores: scores(56, 74, 84, 79, 58),
      pricing: {
    ...
    'qwen-3-235b': {
      vendor: 'qwen',
      class: 'strong_generalist',
      strengths: ['large challenger coverage', 'planning and review breadth'],
      weaknesses: ['watchlist only', 'slower than coder-tuned variants'],
      qualityScores: scores(57, 80, 83, 81, 57),
      pricing: {
        inputCostPerMTok: 0.8,
      ...
      reasoningTier: 'advanced',
      costPerMillionInputTokensUsd: 0.8,
      costPerMillionOutputTokensUsd: 3.2,
      agent: 'claude-openrouter',
    },
    'qwen-2.5-72b': {
      vendor: 'qwen',
      class: 'strong_generalist',
      strengths: ['watchlist breadth', 'cost-effective large model baseline'],
      weaknesses: ['older generation', 'coding weaker than qwen-3-coder'],
      qualityScores: scores(52, 70, 77, 74, 54),
      pricing: {
    ...
    'kimi-k2': {
      vendor: 'moonshotai',
      class: 'frontier',
      strengths: ['frontier challenger coverage', 'planning and coding balance'],
      weaknesses: ['opt-in provider path'],
      qualityScores: scores(58, 86, 85, 84, 57),
      pricing: {
    ...
    'kimi-k2-thinking': {
      vendor: 'moonshotai',
      class: 'strong_generalist',
      strengths: ['reasoning-oriented kimi variant', 'watchlist parity'],
      weaknesses: ['slower than K2 baseline'],
      qualityScores: scores(56, 84, 82, 83, 56),
      pricing: {
        inputCostPerMTok: 2,
        outputCostPerMTok: 8,
      },
    ...
    'gemini-2.5-pro': {
      vendor: 'google',
      class: 'frontier',
      strengths: ['frontier planning coverage', 'large-context coding'],
      weaknesses: ['opt-in provider path'],
      qualityScores: scores(60, 91, 86, 87, 60),
      pricing: {
        inputCostPerMTok: 1.25,
        outputCostPerMTok: 10,
      },
    ...
    'gemini-2.5-flash': {
      vendor: 'google',
      class: 'strong_generalist',
      strengths: ['lower-cost multimodal challenger', 'fast coding'],
      weaknesses: ['less depth than Pro'],
      qualityScores: scores(62, 73, 80, 78, 64),
      pricing: {
    ...
    'gemini-2.0-flash': {
      vendor: 'google',
      class: 'fast_economy',
      strengths: ['economy multimodal watchlist coverage', 'fast response'],
      weaknesses: ['older generation'],
      qualityScores: scores(58, 66, 74, 71, 63),
      pricing: {
    ...
    'llama-3.3-70b': {
      vendor: 'meta',
      class: 'fast_economy',
      strengths: ['open challenger baseline', 'low-cost code generation'],
      weaknesses: ['weaker long-horizon reasoning'],
      qualityScores: scores(54, 66, 75, 72, 58),
      pricing: {
        inputCostPerMTok: 0.12,
    ...
    'llama-4-maverick': {
      vendor: 'meta',
      class: 'strong_generalist',
      strengths: ['planning-capable open model', 'challenger family diversity'],
      weaknesses: ['opt-in provider path'],
      qualityScores: scores(55, 76, 80, 77, 57),
      pricing: {
      ...
      latencyTier: 'standard',
      reasoningTier: 'standard',
      costPerMillionInputTokensUsd: 0.45,
      costPerMillionOutputTokensUsd: 1.4,
      agent: 'claude-openrouter',
    },
    'llama-4-scout': {
      vendor: 'meta',
      class: 'fast_economy',
      strengths: ['cheap watchlist challenger', 'broad ecosystem compatibility'],
      weaknesses: ['lighter capability band'],
      qualityScores: scores(50, 62, 72, 68, 54),
      pricing: {
      ...
      latencyTier: 'fast',
      reasoningTier: 'basic',
      costPerMillionInputTokensUsd: 0.08,
      costPerMillionOutputTokensUsd: 0.3,
      agent: 'claude-openrouter',
    },
    'mistral-large-2': {
      vendor: 'mistral',
      class: 'strong_generalist',
      strengths: ['European frontier challenger', 'balanced plan/code/review'],
      weaknesses: ['watch for model drift across providers'],
      qualityScores: scores(55, 78, 81, 80, 56),
      pricing: {
        inputCostPerMTok: 2,
        outputCostPerMTok: 6,
      },
    ...
    'mistral-medium-3': {
      vendor: 'mistral',
      class: 'strong_generalist',
      strengths: ['mid-tier challenger watchlist', 'balanced cost'],
      weaknesses: ['less proven on coding than large variants'],
      qualityScores: scores(52, 70, 76, 74, 54),
      pricing: {
    ...
    'devstral-small': {
      vendor: 'mistral',
      class: 'fast_economy',
      strengths: ['very low-cost coding challenger', 'launch-pool diversity'],
      weaknesses: ['smaller model capability ceiling'],
      qualityScores: scores(49, 60, 73, 68, 52),
      pricing: {
        inputCostPerMTok: 0.1,
        outputCostPerMTok: 0.3,
      },
    ...
    'devstral-medium': {
      vendor: 'mistral',
      class: 'strong_generalist',
      strengths: ['coding-focused watchlist variant', 'cost-efficient review'],
      weaknesses: ['watchlist only'],
      qualityScores: scores(51, 68, 77, 73, 53),
      pricing: {
        inputCostPerMTok: 0.25,
        outputCostPerMTok: 1,
      },
      ...
      reasoningTier: 'standard',
      costPerMillionInputTokensUsd: 0.25,
      costPerMillionOutputTokensUsd: 1,
      agent: 'claude-openrouter',
    },
    'grok-code-fast': {
      vendor: 'xai',
      class: 'fast_economy',
      strengths: ['coding-specialized challenger', 'fast turnaround'],
      weaknesses: ['watchlist only', 'less historical data'],
      qualityScores: scores(50, 61, 74, 68, 52),
      pricing: {
      ...
      costPerMillionOutputTokensUsd: 0.5,
      agent: 'claude-openrouter',
    },
  },
  ladders: {
