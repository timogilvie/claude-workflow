...
export const DEFAULT_MODEL_REGISTRY: ModelRegistry = {
  models: {
    ...
    'gpt-4o': {
      vendor: 'openai',
      class: 'strong_generalist',
      strengths: ['native read-only pilot', 'tool calling', 'balanced quality/cost'],
      weaknesses: ['older than GPT-5 family', 'not promoted into default routing ladders'],
      qualityScores: scores(0, 84, 0, 82, 0),
      pricing: {
        inputCostPerMTok: 2.5,
    ...
    'gemini-2.5-pro': {
      ...
      pricing: { inputCostPerMTok: 1.25, outputCostPerMTok: 10 },
      defaultLadderEligible: false,
      contextWindowTokens: 1_000_000,
      toolSupport: 'full',
      multimodal: { text: true, image: true },
    ...
    'gemini-2.5-flash': {
      ...
      pricing: { inputCostPerMTok: 0.3, outputCostPerMTok: 2.5 },
      defaultLadderEligible: false,
      contextWindowTokens: 1_000_000,
      toolSupport: 'full',
      multimodal: { text: true, image: true },
    ...
    'deepseek-r1': {
      ...
      pricing: { inputCostPerMTok: 0.55, outputCostPerMTok: 2.2 },
      defaultLadderEligible: false,
      contextWindowTokens: 128_000,
      toolSupport: 'basic',
      multimodal: { text: true, image: false },
      latencyTier: 'slow',
      reasoningTier: 'advanced',
      costPerMillionInputTokensUsd: 0.55,
      costPerMillionOutputTokensUsd: 2.2,
      agent: 'claude',
    },
    'deepseek-v3': {
      vendor: 'deepseek',
    ...
    'kimi-k2': {
      ...
      pricing: { inputCostPerMTok: 1, outputCostPerMTok: 3 },
      defaultLadderEligible: false,
      contextWindowTokens: 200_000,
      toolSupport: 'basic',
      multimodal: { text: true, image: false },
    ...
    'kimi-k2-thinking': {
      ...
      pricing: { inputCostPerMTok: 1.5, outputCostPerMTok: 4.5 },
      defaultLadderEligible: false,
      contextWindowTokens: 200_000,
      toolSupport: 'basic',
      multimodal: { text: true, image: false },
