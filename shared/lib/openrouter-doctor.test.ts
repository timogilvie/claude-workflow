...
const previousRoots = new Map<string, string | undefined>();

function makeRepoDir(): string {
  const repoDir = mkdtempSync(join(tmpdir(), 'openrouter-doctor-'));
  previousRoots.set(repoDir, process.env.WAVEMILL_NATIVE_CERTIFICATION_ROOT);
