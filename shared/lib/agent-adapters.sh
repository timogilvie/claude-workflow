...
- Include detailed test scenarios"
    ...
    depth_guidance="- Create a detailed plan with key decision points
- Research the primary approach and document trade-offs
- Include test scenarios for critical paths"
  else
