...
/**
 * Join challenge comparison records with their primary/challenger evals.
 */
...
/**
 * Compute aggregated challenge statistics for the joined comparison/eval records.
 */
...
/**
 * Format aggregated challenge statistics for terminal output.
 */
export function formatChallengeStats(stats: AggregatedStats): string {
  const lines: string[] = [];
