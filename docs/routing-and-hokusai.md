...
11:31:02 [router] policy adjustment: coder claude-opus-4-8 -> claude-opus-4-7 (quota=degrading, same-class=frontier)
11:31:44 [coder] claude-opus-4-8 unavailable (quota); falling back to claude-opus-4-7
```
