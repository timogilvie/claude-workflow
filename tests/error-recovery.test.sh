...
check_true "codex autonomous launcher uses human readable exec" grep -q 'codex exec --model gpt-5.4 --dangerously-bypass-approvals-and-sandbox - < ' "$AUTONOMOUS_LAUNCHER"
