...
assert_eq "$duplicated_count" "42" "duplicated parent/monitor function count changed"
assert_eq "$identical_count" "34" "byte-identical parent/monitor function count changed"
assert_eq "$divergent_count" "8" "allowlisted divergent parent/monitor function count changed"
...
assert_eq "$new_duplicate_count" "43" "introducing a new duplicated function was not detected" "$new_duplicate_parent" "$new_duplicate_monitor"
